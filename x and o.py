...
def draw_x(x,y):    #Drawing X Shape
    turtle.penup()
    turtle.goto(x,y)
    turtle.pendown()
    turtle.right(45)
...
def draw_circle(x,y):     #Drawing Circle
    turtle.penup()
    turtle.goto(x,y)
    turtle.pendown()
    turtle.circle(30)
...
def draw_horizontal_line(x,y):  #Draw Horizontal line when matches
    turtle.penup()
    turtle.goto(x,y)
    turtle.pendown()
    turtle.right(90)
...
def draw_vertical_line(x,y):     #Draw Vertical Line when Matches
    turtle.penup()
    turtle.goto(x,y)
    turtle.pendown()
    turtle.right(180)
...
def draw_left_angle_line(x,y):    #Draw diagonal from top left when matches
    turtle.penup()
    turtle.goto(x,y)
    turtle.pendown()
    turtle.right(135)
...
def draw_right_angle_line(x,y):   #Draw diagonal from top right when matches
    turtle.penup()
    turtle.goto(x,y)
    turtle.pendown()
    turtle.left(135)
...
def draw_marker(player, player_pos):   # Draw X or O on board
    
    if player_pos == 1 and player == 'o' :    # circle index 1
        draw_circle(80,50)
        
    elif player_pos == 2 and player == 'o':   # circle index 2
        draw_circle(180,50)
        
    elif player_pos == 3 and player == 'o':   # circle index 3
        draw_circle(280,50)
        
    elif player_pos == 4 and player == 'o':   # circle index 4
        draw_circle(80,-40)

    elif player_pos == 5 and player == 'o':   # circle index 5
        draw_circle(180,-40)
        
    elif player_pos == 6 and player == 'o':   # circle index 6
        draw_circle(280,-40)
        
    elif player_pos == 7 and player == 'o':   # circle index 7
        draw_circle(80,-140)
        
    elif player_pos == 8 and player == 'o':   # circle index 8
        draw_circle(180,-140)
            
    elif player_pos == 9 and player == 'o':   # circle index 9
        draw_circle(280,-140)

    elif player_pos == 1 and player == 'x':   # draw x index 1    
        draw_x(10,10)
            
    elif player_pos == 2 and player == 'x':   # draw x index 2 
        draw_x(110,10)
            
    elif player_pos == 3 and player == 'x':   # draw x index 3 
        draw_x(210,10)

    elif player_pos == 4 and player == 'x':   # draw x index 4
        draw_x(10,-90)
            
    elif player_pos == 5 and player == 'x':   # draw x index 5
        draw_x(110,-90)
            
    elif player_pos == 6 and player == 'x':   # draw x index 6
        draw_x(210,-90)
            
    elif player_pos == 7 and player == 'x':   # draw x index 7
        draw_x(10,-190)
            
    elif player_pos == 8 and player == 'x':   # draw x index 8
        draw_x(110,-190)
            
    else:                                     # draw x index 9
        draw_x(210,-190)
    
# Ending Turtle Section #
            ...
            while player1 != 'x' or player1 != 'o':
		        ...
		        # End of Player 1#
                        ...
                        if vs == 1 :
                         ...
                         # Check for player 2 , It can be a human or Computer # 
                            if check_wins(player2) == True :
                                print ('Player ', player2 , 'wins !!!!!')
                                break
                        # Player 2 Ends #
                        # check if the last person with the last space has won #
